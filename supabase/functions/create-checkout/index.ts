...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: validateRedirectUrl(successUrl, 'https://wordlabs.app/dashboard?upgraded=1'),
      cancel_url: validateRedirectUrl(cancelUrl, 'https://wordlabs.app/pricing.html'),
      metadata: {
        school_id: school.id,
