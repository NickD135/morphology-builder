...
const EXT_MEANING_PREFIXES = [
  {id:"ambi",   form:"ambi",   meaning:"both sides",              examples:["<u>ambi</u>dextrous","<u>ambi</u>guous","<u>ambi</u>valent"]},
  {id:"ante",   form:"ante",   meaning:"before or in front of",   examples:["<u>ante</u>cedent","<u>ante</u>room","<u>ante</u>date"]},
  {id:"apo",    form:"apo",    meaning:"away from or separate",   examples:["<u>apo</u>logy","<u>apo</u>stle","<u>apo</u>theosis"]},
  {id:"astro",  form:"astro",  meaning:"star or outer space",     examples:["<u>astro</u>naut","<u>astro</u>nomy","<u>astro</u>logy"]},
  {id:"auto",   form:"auto",   meaning:"self or by itself",       examples:["<u>auto</u>matic","<u>auto</u>biography","<u>auto</u>mobile"]},
  {id:"bene",   form:"bene",   meaning:"good or well",            examples:["<u>bene</u>fit","<u>bene</u>volent","<u>bene</u>ficial"]},
  {id:"bi",     form:"bi",     meaning:"two or twice",            examples:["<u>bi</u>cycle","<u>bi</u>lingual","<u>bi</u>noculars"]},
  {id:"bio",    form:"bio",    meaning:"life",                    examples:["<u>bio</u>logy","<u>bio</u>graphy","<u>bio</u>diversity"]},
  {id:"cardio", form:"cardio", meaning:"heart",                   examples:["<u>cardio</u>vascular","<u>cardio</u>logist","<u>cardio</u>logy"]},
  {id:"cata",   form:"cata",   meaning:"down or completely",      examples:["<u>cata</u>logue","<u>cata</u>strophe","<u>cata</u>lyst"]},
  {id:"chrono", form:"chrono", meaning:"time",                    examples:["<u>chrono</u>logical","<u>chron</u>icle","<u>chrono</u>meter"]},
  {id:"circum", form:"circum", meaning:"around",                  examples:["<u>circum</u>ference","<u>circum</u>stance","<u>circum</u>navigate"]},
  {id:"cosmo",  form:"cosmo",  meaning:"universe or world",       examples:["<u>cosmo</u>politan","<u>cosmo</u>naut","<u>cosmo</u>logy"]},
  {id:"crypto", form:"crypto", meaning:"hidden or secret",        examples:["<u>crypto</u>graphy","<u>crypto</u>currency","<u>crypt</u>ic"]},
  {id:"cyber",  form:"cyber",  meaning:"computers or internet",   examples:["<u>cyber</u>security","<u>cyber</u>space","<u>cyber</u>bullying"]},
  {id:"demo",   form:"demo",   meaning:"people",                  examples:["<u>demo</u>cracy","<u>demo</u>graphics","<u>demo</u>nstration"]},
  {id:"dia",    form:"dia",    meaning:"through or across",       examples:["<u>dia</u>logue","<u>dia</u>meter","<u>dia</u>gnosis"]},
  {id:"eco",    form:"eco",    meaning:"environment or ecology",  examples:["<u>eco</u>system","<u>eco</u>logy","<u>eco</u>nomics"]},
  {id:"electro",form:"electro",meaning:"electricity",             examples:["<u>electr</u>icity","<u>electro</u>nics","<u>electro</u>magnetic"]},
  {id:"eu",     form:"eu",     meaning:"good or well or pleasant",examples:["<u>eu</u>phoria","<u>eu</u>logy","<u>eu</u>phemism"]},
  {id:"ethno",  form:"ethno",  meaning:"people or culture",       examples:["<u>ethn</u>icity","<u>ethno</u>graphy","<u>ethno</u>logy"]},
  {id:"geo",    form:"geo",    meaning:"earth",                   examples:["<u>geo</u>graphy","<u>geo</u>logy","<u>geo</u>metry"]},
  {id:"hemi",   form:"hemi",   meaning:"half",                    examples:["<u>hemi</u>sphere","<u>hemi</u>cycle","<u>hemi</u>plegia"]},
  {id:"hetero", form:"hetero", meaning:"different or other",      examples:["<u>hetero</u>geneous","<u>hetero</u>nym","<u>hetero</u>dox"]},
  {id:"homo",   form:"homo",   meaning:"same",                    examples:["<u>homo</u>geneous","<u>homo</u>phone","<u>homo</u>nym"]},
  {id:"hydro",  form:"hydro",  meaning:"water",                   examples:["<u>hydro</u>gen","<u>hydro</u>electric","<u>hydr</u>ation"]},
  {id:"hypo",   form:"hypo",   meaning:"under or below normal",   examples:["<u>hypo</u>thesis","<u>hypo</u>thermia","<u>hypo</u>dermic"]},
  {id:"infra",  form:"infra",  meaning:"below or beneath",        examples:["<u>infra</u>structure","<u>infra</u>red","<u>infra</u>sound"]},
  {id:"litho",  form:"litho",  meaning:"stone or rock",           examples:["<u>litho</u>graph","<u>litho</u>sphere","<u>lithi</u>um"]},
  {id:"macro",  form:"macro",  meaning:"large or long",           examples:["<u>macro</u>scopic","<u>macro</u>economics","<u>macro</u>biotic"]},
  {id:"meta",   form:"meta",   meaning:"beyond or change",        examples:["<u>meta</u>phor","<u>meta</u>bolism","<u>meta</u>morphosis"]},
  {id:"micro",  form:"micro",  meaning:"small or tiny",           examples:["<u>micro</u>scope","<u>micro</u>phone","<u>micro</u>chip"]},
  {id:"mono",   form:"mono",   meaning:"one or single",           examples:["<u>mono</u>logue","<u>mono</u>poly","<u>mono</u>chrome"]},
  {id:"morpho", form:"morpho", meaning:"form or shape",           examples:["<u>morpho</u>logy","<u>morph</u>eme","meta<u>morpho</u>sis"]},
  {id:"neo",    form:"neo",    meaning:"new or recent",           examples:["<u>neo</u>natal","<u>neo</u>classical","<u>neo</u>n"]},
  {id:"neuro",  form:"neuro",  meaning:"nerve or nervous system", examples:["<u>neuro</u>science","<u>neuro</u>logy","<u>neuro</u>n"]},
  {id:"omni",   form:"omni",   meaning:"all or every",            examples:["<u>omni</u>vore","<u>omni</u>scient","<u>omni</u>present"]},
  {id:"ortho",  form:"ortho",  meaning:"straight or correct",     examples:["<u>ortho</u>dox","<u>ortho</u>dontist","<u>ortho</u>graphy"]},
  {id:"paleo",  form:"paleo",  meaning:"ancient or early",        examples:["<u>paleo</u>ntology","<u>paleo</u>lithic","<u>paleo</u>climate"]},
  {id:"para",   form:"para",   meaning:"beside or beyond",        examples:["<u>para</u>graph","<u>para</u>chute","<u>para</u>llel"]},
  {id:"patho",  form:"patho",  meaning:"disease or suffering",    examples:["<u>patho</u>logy","<u>patho</u>gen","<u>patho</u>logist"]},
  {id:"peri",   form:"peri",   meaning:"around or near",          examples:["<u>peri</u>meter","<u>peri</u>scope","<u>peri</u>pheral"]},
  {id:"phil",   form:"phil",   meaning:"love or fond of",         examples:["<u>phil</u>osophy","<u>phil</u>anthropy","biblio<u>phil</u>e"]},
  {id:"photo",  form:"photo",  meaning:"light",                   examples:["<u>photo</u>graph","<u>photo</u>synthesis","<u>photo</u>n"]},
  {id:"poly",   form:"poly",   meaning:"many or much",            examples:["<u>poly</u>gon","<u>poly</u>glot","<u>poly</u>chrome"]},
  {id:"proto",  form:"proto",  meaning:"first or original",       examples:["<u>proto</u>type","<u>proto</u>col","<u>proto</u>zoa"]},
  {id:"pseudo", form:"pseudo", meaning:"false or fake",           examples:["<u>pseudo</u>nym","<u>pseudo</u>science","<u>pseudo</u>pod"]},
  {id:"psycho", form:"psycho", meaning:"mind or mental",          examples:["<u>psycho</u>logy","<u>psycho</u>logist","<u>psycho</u>therapy"]},
  {id:"pyro",   form:"pyro",   meaning:"fire",                    examples:["<u>pyro</u>technics","<u>pyro</u>maniac","<u>pyro</u>clastic"]},
  {id:"retro",  form:"retro",  meaning:"backwards or behind",     examples:["<u>retro</u>spect","<u>retro</u>grade","<u>retro</u>fit"]},
  {id:"socio",  form:"socio",  meaning:"society or social",       examples:["<u>socio</u>logy","<u>socio</u>path","<u>socio</u>economic"]},
  {id:"syn",    form:"syn",    meaning:"together or with",        examples:["<u>syn</u>onym","<u>syn</u>thesis","<u>syn</u>chronise"]},
  {id:"techno", form:"techno", meaning:"technology or skill",     examples:["<u>techno</u>logy","<u>techn</u>ique","<u>techno</u>crat"]},
  {id:"tele",   form:"tele",   meaning:"far or at a distance",   examples:["<u>tele</u>phone","<u>tele</u>scope","<u>tele</u>vision"]},
  {id:"thermo", form:"thermo", meaning:"heat",                    examples:["<u>thermo</u>meter","<u>thermo</u>stat","<u>thermo</u>s"]},
  {id:"tri",    form:"tri",    meaning:"three",                   examples:["<u>tri</u>angle","<u>tri</u>cycle","<u>tri</u>logy"]},
  {id:"ultra",  form:"ultra",  meaning:"beyond or extreme",       examples:["<u>ultra</u>violet","<u>ultra</u>sound","<u>ultra</u>modern"]},
  {id:"uni",    form:"uni",    meaning:"one",                     examples:["<u>uni</u>verse","<u>uni</u>corn","<u>uni</u>form"]},
  {id:"zoo",    form:"zoo",    meaning:"animal or living creature",examples:["<u>zoo</u>logy","<u>zoo</u>keeper","<u>zoo</u>logist"]},
];

const EXT_MEANING_SUFFIXES = [
  {id:"archy",   form:"archy",   meaning:"rule or government",        examples:["mon<u>archy</u>","an<u>archy</u>","olig<u>archy</u>"]},
  {id:"ase",     form:"ase",     meaning:"enzyme",                    examples:["lip<u>ase</u>","prote<u>ase</u>","amyl<u>ase</u>"]},
  {id:"cide",    form:"cide",    meaning:"killing or killer",         examples:["insecti<u>cide</u>","pesti<u>cide</u>","herbi<u>cide</u>"]},
  {id:"cracy",   form:"cracy",   meaning:"rule or power",             examples:["demo<u>cracy</u>","bureau<u>cracy</u>","theo<u>cracy</u>"]},
  {id:"cyte",    form:"cyte",    meaning:"cell",                      examples:["leuco<u>cyte</u>","erythro<u>cyte</u>","lympho<u>cyte</u>"]},
  {id:"derm",    form:"derm",    meaning:"skin layer",                examples:["epi<u>derm</u>is","pachy<u>derm</u>","<u>derm</u>atology"]},
  {id:"gamy",    form:"gamy",    meaning:"marriage or union",         examples:["mono<u>gamy</u>","bi<u>gamy</u>","poly<u>gamy</u>"]},
  {id:"gen",     form:"gen",     meaning:"producing or origin",       examples:["oxy<u>gen</u>","hydro<u>gen</u>","aller<u>gen</u>"]},
  {id:"genesis", form:"genesis", meaning:"origin or creation",        examples:["bio<u>genesis</u>","<u>genesis</u>","photo<u>genesis</u>"]},
  {id:"genic",   form:"genic",   meaning:"producing or suitable for", examples:["photo<u>genic</u>","aller<u>genic</u>","carcino<u>genic</u>"]},
  {id:"gram",    form:"gram",    meaning:"written or recorded",       examples:["tele<u>gram</u>","dia<u>gram</u>","kilo<u>gram</u>"]},
  {id:"graph",   form:"graph",   meaning:"writing or recording",      examples:["para<u>graph</u>","photo<u>graph</u>","auto<u>graph</u>"]},
  {id:"hedron",  form:"hedron",  meaning:"geometric solid face",      examples:["poly<u>hedron</u>","tetra<u>hedron</u>","dodeca<u>hedron</u>"]},
  {id:"itis",    form:"itis",    meaning:"inflammation of",           examples:["arthr<u>itis</u>","bronch<u>itis</u>","dermat<u>itis</u>"]},
  {id:"kinesis", form:"kinesis", meaning:"movement or motion",        examples:["tele<u>kinesis</u>","psycho<u>kinesis</u>","cyto<u>kinesis</u>"]},
  {id:"latry",   form:"latry",   meaning:"worship or devotion",       examples:["ido<u>latry</u>","bardo<u>latry</u>","zoo<u>latry</u>"]},
  {id:"logue",   form:"logue",   meaning:"word or speech",            examples:["pro<u>logue</u>","dia<u>logue</u>","mono<u>logue</u>"]},
  {id:"lysis",   form:"lysis",   meaning:"breaking down",             examples:["ana<u>lysis</u>","para<u>lysis</u>","cata<u>lysis</u>"]},
  {id:"mancy",   form:"mancy",   meaning:"divination or prediction",  examples:["necro<u>mancy</u>","pyro<u>mancy</u>","chiro<u>mancy</u>"]},
  {id:"morph",   form:"morph",   meaning:"form or shape",             examples:["poly<u>morph</u>","meta<u>morph</u>","iso<u>morph</u>"]},
  {id:"nomy",    form:"nomy",    meaning:"law or management of",      examples:["astro<u>nomy</u>","eco<u>nomy</u>","taxo<u>nomy</u>"]},
  {id:"nym",     form:"nym",     meaning:"word or name",              examples:["syno<u>nym</u>","anto<u>nym</u>","pseudo<u>nym</u>"]},
  {id:"oid",     form:"oid",     meaning:"resembling or like",        examples:["aster<u>oid</u>","human<u>oid</u>","andr<u>oid</u>"]},
  {id:"ology",   form:"ology",   meaning:"study of",                  examples:["bi<u>ology</u>","zo<u>ology</u>","psych<u>ology</u>"]},
  {id:"pathy",   form:"pathy",   meaning:"feeling or disease",        examples:["sym<u>pathy</u>","em<u>pathy</u>","tele<u>pathy</u>"]},
  {id:"phile",   form:"phile",   meaning:"lover of",                  examples:["biblio<u>phile</u>","audio<u>phile</u>","anglo<u>phile</u>"]},
  {id:"phobia",  form:"phobia",  meaning:"fear of",                   examples:["claustro<u>phobia</u>","arachno<u>phobia</u>","hydro<u>phobia</u>"]},
  {id:"phone",   form:"phone",   meaning:"sound or voice",            examples:["micro<u>phone</u>","tele<u>phone</u>","saxo<u>phone</u>"]},
  {id:"plasm",   form:"plasm",   meaning:"form or living substance",  examples:["cyto<u>plasm</u>","proto<u>plasm</u>","bio<u>plasm</u>"]},
  {id:"pod",     form:"pod",     meaning:"foot or leg",               examples:["tri<u>pod</u>","arthro<u>pod</u>","gastro<u>pod</u>"]},
  {id:"scope",   form:"scope",   meaning:"instrument for viewing",    examples:["tele<u>scope</u>","micro<u>scope</u>","peri<u>scope</u>"]},
  {id:"sophy",   form:"sophy",   meaning:"wisdom or knowledge",       examples:["philo<u>sophy</u>","theo<u>sophy</u>","anthropo<u>sophy</u>"]},
  {id:"stasis",  form:"stasis",  meaning:"standing still or stability",examples:["homeo<u>stasis</u>","meta<u>stasis</u>","hemo<u>stasis</u>"]},
  {id:"tomy",    form:"tomy",    meaning:"cutting or incision",       examples:["ana<u>tomy</u>","dicho<u>tomy</u>","lobo<u>tomy</u>"]},
  {id:"trophy",  form:"trophy",  meaning:"nourishment or growth",     examples:["hyper<u>trophy</u>","a<u>trophy</u>","dys<u>trophy</u>"]},
  {id:"tude",    form:"tude",    meaning:"state or condition",        examples:["magni<u>tude</u>","grati<u>tude</u>","soli<u>tude</u>"]},
  {id:"type",    form:"type",    meaning:"model or pattern",          examples:["proto<u>type</u>","arche<u>type</u>","stereo<u>type</u>"]},
  {id:"vore",    form:"vore",    meaning:"feeding on",                examples:["herbi<u>vore</u>","carni<u>vore</u>","omni<u>vore</u>"]},
  {id:"ward",    form:"ward",    meaning:"direction or towards",      examples:["for<u>ward</u>","back<u>ward</u>","home<u>ward</u>"]},
];
...
const EXT_MEANING_BASES = [
  // Greek roots
  {id:"anthrop", form:"anthrop", meaning:"human being",            examples:["<u>anthrop</u>ology","phil<u>anthrop</u>y","mis<u>anthrop</u>e"]},
  {id:"bio",     form:"bio",     meaning:"life",                  examples:["<u>bio</u>logy","<u>bio</u>graphy","<u>bio</u>psy"]},
  {id:"chron",   form:"chron",   meaning:"time",                  examples:["<u>chron</u>icle","<u>chron</u>ology","syn<u>chron</u>ise"]},
  {id:"cosm",    form:"cosm",    meaning:"universe or order",     examples:["<u>cosm</u>ic","<u>cosm</u>opolitan","micro<u>cosm</u>"]},
  {id:"dem",     form:"dem",     meaning:"people",                examples:["<u>dem</u>ocracy","epi<u>dem</u>ic","pan<u>dem</u>ic"]},
  {id:"derm",    form:"derm",    meaning:"skin",                  examples:["<u>derm</u>atology","epi<u>derm</u>is","<u>derm</u>atitis"]},
  {id:"dyn",     form:"dyn",     meaning:"power or force",        examples:["<u>dyn</u>amic","<u>dyn</u>amite","<u>dyn</u>asty"]},
  {id:"gen",     form:"gen",     meaning:"origin or birth",       examples:["<u>gen</u>etics","<u>gen</u>eration","<u>gen</u>esis"]},
  {id:"geo",     form:"geo",     meaning:"earth",                 examples:["<u>geo</u>graphy","<u>geo</u>logy","<u>geo</u>thermal"]},
  {id:"morph",   form:"morph",   meaning:"form or shape",         examples:["<u>morph</u>ology","meta<u>morph</u>osis","a<u>morph</u>ous"]},
  {id:"path",    form:"path",    meaning:"feeling or disease",    examples:["<u>path</u>ology","sym<u>path</u>y","em<u>path</u>y"]},
  {id:"phil",    form:"phil",    meaning:"love or fondness",       examples:["<u>phil</u>osophy","<u>phil</u>anthropy","<u>phil</u>harmonic"]},
  {id:"phob",    form:"phob",    meaning:"fear",                  examples:["<u>phob</u>ia","claustro<u>phob</u>ic","arachno<u>phob</u>ia"]},
  {id:"psych",   form:"psych",   meaning:"mind or soul",          examples:["<u>psych</u>ology","<u>psych</u>iatry","<u>psych</u>ic"]},
  {id:"soph",    form:"soph",    meaning:"wisdom or knowledge",   examples:["philo<u>soph</u>y","<u>soph</u>isticated","<u>soph</u>omore"]},
  {id:"therm",   form:"therm",   meaning:"heat",                  examples:["<u>therm</u>ometer","<u>therm</u>al","<u>therm</u>ostat"]},
  {id:"tox",     form:"tox",     meaning:"poison",                examples:["<u>tox</u>ic","<u>tox</u>icology","de<u>tox</u>ify"]},
  {id:"zoo",     form:"zoo",     meaning:"animal or living being",examples:["<u>zoo</u>logy","<u>zoo</u>keeper","<u>zoo</u>logist"]},
  // Latin roots
  {id:"aqu",     form:"aqu",     meaning:"water",                 examples:["<u>aqu</u>arium","<u>aqu</u>atic","<u>aqu</u>educt"]},
  {id:"capit",   form:"capit",   meaning:"head or chief",         examples:["<u>capit</u>al","<u>capt</u>ain","de<u>capit</u>ate"]},
  {id:"corp",    form:"corp",    meaning:"body",                  examples:["<u>corp</u>oration","<u>corp</u>se","in<u>corp</u>orate"]},
  {id:"fin",     form:"fin",     meaning:"end or limit",          examples:["<u>fin</u>al","<u>fin</u>ish","in<u>fin</u>ite"]},
  {id:"flu",     form:"flu",     meaning:"flow",                  examples:["<u>flu</u>id","in<u>flu</u>ence","<u>flu</u>ent"]},
  {id:"man",     form:"man",     meaning:"hand",                  examples:["<u>man</u>ual","<u>man</u>uscript","<u>man</u>icure"]},
  {id:"mar",     form:"mar",     meaning:"sea",                   examples:["<u>mar</u>ine","<u>mar</u>itime","sub<u>mar</u>ine"]},
  {id:"mort",    form:"mort",    meaning:"death",                 examples:["<u>mort</u>al","<u>mort</u>gage","im<u>mort</u>al"]},
  {id:"nov",     form:"nov",     meaning:"new",                   examples:["<u>nov</u>el","in<u>nov</u>ation","re<u>nov</u>ate"]},
  {id:"sol",     form:"sol",     meaning:"sun or alone",          examples:["<u>sol</u>ar","<u>sol</u>itary","<u>sol</u>stice"]},
  {id:"termin",  form:"termin",  meaning:"end or boundary",       examples:["<u>termin</u>al","<u>termin</u>ate","de<u>termin</u>e"]},
  {id:"vita",    form:"vita",    meaning:"life",                  examples:["<u>vita</u>min","<u>vita</u>l","<u>vita</u>lity"]},
  {id:"voc",     form:"voc",     meaning:"call or voice",         examples:["<u>voc</u>abulary","<u>voc</u>al","ad<u>voc</u>ate"]},
  // Combining forms
  {id:"astro",   form:"astro",   meaning:"star or outer space",   examples:["<u>astro</u>naut","<u>astro</u>nomy","<u>astro</u>physics"]},
  {id:"eco",     form:"eco",     meaning:"environment or household",examples:["<u>eco</u>system","<u>eco</u>logy","<u>eco</u>nomy"]},
  {id:"hydro",   form:"hydro",   meaning:"water",                 examples:["<u>hydro</u>electric","<u>hydro</u>gen","<u>hydr</u>ate"]},
  {id:"photo",   form:"photo",   meaning:"light",                 examples:["<u>photo</u>graph","<u>photo</u>synthesis","<u>photo</u>n"]},
  {id:"poly",    form:"poly",    meaning:"many or much",          examples:["<u>poly</u>gon","<u>poly</u>ester","<u>poly</u>chrome"]},
  {id:"pyro",    form:"pyro",    meaning:"fire",                  examples:["<u>pyro</u>technics","<u>pyro</u>maniac","<u>pyre</u>"]},
  {id:"geno",    form:"geno",    meaning:"origin or race",        examples:["<u>geno</u>cide","<u>geno</u>me","<u>gene</u>alogy"]},
  {id:"oxy",     form:"oxy",     meaning:"sharp or acid",         examples:["<u>oxy</u>gen","<u>ox</u>idise","per<u>ox</u>ide"]},
  {id:"techno",  form:"techno",  meaning:"technology or skill",   examples:["<u>techno</u>logy","<u>techn</u>ique","<u>techno</u>crat"]},
];
