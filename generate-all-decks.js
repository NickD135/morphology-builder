...
const ALL_MORPHEMES = [
  ...
  // ── GREEK COMBINING FORMS (Phase 7.12) ──
  { morpheme: "tele", type: "base" },
  { morpheme: "peri", type: "base" },
  { morpheme: "gyro", type: "base" },
  { morpheme: "endo", type: "base" },
  { morpheme: "horo", type: "base" },
  { morpheme: "stetho", type: "base" },
  { morpheme: "kaleido", type: "base" },

  // ── LATIN ROOTS (Phase 7.15) ──
  { morpheme: "grad", type: "base" },
  { morpheme: "mot", type: "base" },

  // ── ANGLO BASES (Phase 7.14 — 45 new) ──
  { morpheme: "play", type: "base" },
  { morpheme: "work", type: "base" },
  { morpheme: "read", type: "base" },
  { morpheme: "think", type: "base" },
  { morpheme: "kind", type: "base" },
  { morpheme: "hope", type: "base" },
  { morpheme: "fear", type: "base" },
  { morpheme: "thank", type: "base" },
  { morpheme: "harm", type: "base" },
  { morpheme: "taste", type: "base" },
  { morpheme: "doubt", type: "base" },
  { morpheme: "count", type: "base" },
  { morpheme: "start", type: "base" },
  { morpheme: "stop", type: "base" },
  { morpheme: "hold", type: "base" },
  { morpheme: "fill", type: "base" },
  { morpheme: "print", type: "base" },
  { morpheme: "heat", type: "base" },
  { morpheme: "paint", type: "base" },
  { morpheme: "load", type: "base" },
  { morpheme: "order", type: "base" },
  { morpheme: "spell", type: "base" },
  { morpheme: "clean", type: "base" },
  { morpheme: "sharp", type: "base" },
  { morpheme: "bright", type: "base" },
  { morpheme: "fair", type: "base" },
  { morpheme: "safe", type: "base" },
  { morpheme: "deep", type: "base" },
  { morpheme: "weak", type: "base" },
  { morpheme: "soft", type: "base" },
  { morpheme: "dark", type: "base" },
  { morpheme: "sweet", type: "base" },
  { morpheme: "quick", type: "base" },
  { morpheme: "slow", type: "base" },
  { morpheme: "warm", type: "base" },
  { morpheme: "fresh", type: "base" },
  { morpheme: "hard", type: "base" },
  { morpheme: "price", type: "base" },
  { morpheme: "cover", type: "base" },
  { morpheme: "land", type: "base" },
  { morpheme: "test", type: "base" },
  { morpheme: "grace", type: "base" },
  { morpheme: "comfort", type: "base" },
  { morpheme: "agree", type: "base" },
  { morpheme: "colour", type: "base" },

  // ── NEW BASES 2026-07-03 (everyday-prefix bases added to Morpheme Builder) ──
  { morpheme: "day",         type: "base" },
  { morpheme: "way",         type: "base" },
  { morpheme: "field",       type: "base" },
  { morpheme: "week",        type: "base" },
  { morpheme: "fiction",     type: "base" },
  { morpheme: "sense",       type: "base" },
  { morpheme: "stick",       type: "base" },
  { morpheme: "fat",         type: "base" },
  { morpheme: "colon",       type: "base" },
  { morpheme: "cycle",       type: "base" },
  { morpheme: "plane",       type: "base" },
  { morpheme: "lingual",     type: "base" },
  { morpheme: "annual",      type: "base" },
  { morpheme: "angle",       type: "base" },
  { morpheme: "pod",         type: "base" },
  { morpheme: "phone",       type: "base" },
  { morpheme: "byte",        type: "base" },
  { morpheme: "star",        type: "base" },
  { morpheme: "bit",         type: "base" },
  { morpheme: "bus",         type: "base" },
  { morpheme: "van",         type: "base" },
  { morpheme: "skirt",       type: "base" },
  { morpheme: "beast",       type: "base" },
  { morpheme: "violet",      type: "base" },
  { morpheme: "marine",      type: "base" },
  { morpheme: "light",       type: "base" },
  { morpheme: "curricular",  type: "base" },
  { morpheme: "terrestrial", type: "base" },
  { morpheme: "nutrition",   type: "base" },
  { morpheme: "treat",       type: "base" },
  { morpheme: "war",         type: "base" },
  { morpheme: "game",        type: "base" },
  { morpheme: "graduate",    type: "base" },
  { morpheme: "vore",        type: "base" },
  { morpheme: "present",     type: "base" },
  { morpheme: "potent",      type: "base" },
  { morpheme: "band",        type: "base" },
  { morpheme: "flow",        type: "base" },

  // ── PREFIXES (40) ──
  { morpheme: "mini",   type: "prefix" },
  ...
  { morpheme: "be",     type: "prefix" },
  { morpheme: "hypo",   type: "prefix" },
  { morpheme: "circum", type: "prefix" },
  { morpheme: "uni",    type: "prefix" },
  { morpheme: "arch",   type: "prefix" },
  ...
  { morpheme: "age",    type: "suffix" },
  { morpheme: "ory",    type: "suffix" },
  { morpheme: "ary",    type: "suffix" },
  { morpheme: "ise",    type: "suffix" },
  { morpheme: "ious",   type: "suffix" },
  { morpheme: "eous",   type: "suffix" },
  { morpheme: "ative",  type: "suffix" },
  { morpheme: "sion",   type: "suffix" },
  { morpheme: "ation",  type: "suffix" },
