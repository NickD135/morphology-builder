...
INSERT INTO resources (unit_id, outcome_id, type, label, url, scope, class_id) VALUES
  ...
  ('u37', 'r5', 'video', 'Same Perimeter — Different Areas (Grade 3) | MATH-N-ROLL', 'https://www.youtube.com/watch?v=0Ho8Az8y4Mw', 'global', NULL),
  ('u37', 'r5', 'video', 'Same Perimeter — Different Area (Grade 3 Math) | JoAnn''s School', 'https://www.youtube.com/watch?v=R4SNnVceMz4', 'global', NULL),
