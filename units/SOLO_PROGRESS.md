...
| u29 | 3D Space & Volume | ✅ complete | ❌ NOT BUILT | ✅ 45 rows (SQL run) |
| u30 | Angles & Time | ✅ complete | ❌ NOT BUILT | ✅ 42 rows (SQL run) |
| u31 | Number: Place Value, %, Multiplicative | ✅ complete | ❌ NOT BUILT | ✅ 46 rows (SQL run) |
| u32 | 2D Space & Area | ✅ complete | ❌ NOT BUILT | ⏳ 41 rows — `units/u32/04_insert.sql` NOT yet run |
| u33 | Multiplicative Strategies, Rates & Order of Ops | ✅ complete | ❌ NOT BUILT | ⏳ 43 rows — `units/u33/04_insert.sql` NOT yet run |
| u34 | Mass, Length, Additive & Fractions (multi-strand) | ❌ NOT STARTED | ❌ NOT BUILT | — |
| u35 | (not yet inspected) | ❌ NOT STARTED | ❌ NOT BUILT | — |

**Outcome counts:** u29 = 13 (4R/6Y/3G) · u30 = 13 · u31 = 13 · u32 = 12 (4R/5Y/3G) · u33 = 13.
